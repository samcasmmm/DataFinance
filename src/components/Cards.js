      ...
      <div className="w-full py-[10rem] px-4 bg-white">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8">
          <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
            ...
            <p className="text-center font-medium">₹599</p>
            <div>
          ...
          <div className="w-full shadow-xl flex flex-col p-4 md:my-0 my-8 rounded-lg hover:scale-105 duration-300 bg-gray-100">
            ...
            <p className="text-center font-medium">₹999</p>
            <div>
              <p className="py-2 border-b mx-8 mt-8">500 GB Storage</p>
              <p className="py-2 border-b mx-8">2 Grated User</p>
          ...
          <div className="w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300">
            ...
            <p className="text-center font-medium">₹1499</p>
            <div>
              <p className="py-2 border-b mx-8 mt-8">1000 GB Storage</p>
              <p className="py-2 border-b mx-8">3 Grated User</p>
